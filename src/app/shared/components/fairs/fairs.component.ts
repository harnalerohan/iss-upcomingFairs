...
export class Fairs implements OnInit{
  constructor() {}
  upcomingFairsP: IUpcomingFairs[] = [
    {
  ...
  ngOnInit(){
    this.upcomingFairsP[0]['backgroundString'] = `linear-gradient(180deg,rgba(226, 226, 226, 0.318),rgba(63, 71, 79, 0.821)), url(${this.upcomingFairsP[0].bannerUrl})`
    this.selectedItem = this.upcomingFairsP[0];
  }

  getSelectedCardDetails = (cardDetails: IUpcomingFairs) => {
    this.selectedItem = cardDetails;
  }
}
